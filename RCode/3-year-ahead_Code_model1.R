...
return(logdens)"
  ...
  f(ID_year1, model="rw1", hyper=list(prec=list(prior=sdunif)), constr = TRUE) +
  f(ID_year2, model="rw1", hyper=list(prec=list(prior=sdunif)), constr = TRUE)

  shared_unst_rw1_ad = inla(formula,
                   family = "poisson",
                   data = data,
                   E=population,
  ...
  shared_unst_rw1_t1 = inla(formula,
                   family = "poisson",
                   data = data,
                   E=population,
                   control.compute=list(dic=TRUE,
  ...
  shared_unst_rw1_t2 = tryCatch({ inla(formula,
                              family = "poisson",
                              data = data,
                              E=population,
                              control.compute=list(dic=TRUE,
  ...
  shared_unst_rw1_t3 = tryCatch({ inla(formula,
                              family = "poisson",
                              data = data,
                              E=population,
                              control.compute=list(dic=TRUE,
  ...
  shared_unst_rw1_t4 = tryCatch({ inla(formula,
                              family = "poisson",
                              data = data,
                              E=population,
                              control.compute=list(dic=TRUE,
  ...
  ## save                               ##
  ########################################
  results.model1 <- list(shared_ad=shared_unst_rw1_ad,
                         shared_t1=shared_unst_rw1_t1,
                         shared_t2=shared_unst_rw1_t2,
                         shared_t3=shared_unst_rw1_t3,
                         shared_t4=shared_unst_rw1_t4)
  save(results.model1, file=paste0("./resul/",years.ahead,"_year_ahead/",t.from,"-",t.to,"/results_model1.RData"))
